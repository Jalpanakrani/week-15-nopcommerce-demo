...
public class RegisterPage extends Utility {
    ...
    public void clickOnFemaleRadioButton() {
        ...
        log.info(" click on female radio button : " + femalradioButton.toString());
    }
    ...
    public void enterEmail(String email) {
        sendTextToElement(emailField, "priya" + num + "@gmail.com");
    ...
    public void enterConfirmPassword(String confirmpasword) {
        ...
        log.info(" Enter confirm Password : " + confirmpasword + " to confimr password field " + confirmPassowordField.toString());
    }
